...
GetFileInfoResponse = namedtuple(
    'GetFileInfoResponse', 'currentFileInModelpool files')
    ...
    def getFileInfo(self, fid=None, filename=None, extraKey=None, newest=None, hasExtraKey=None):
        ...
        for rspFile in rsp['files']:
            ...
            if 'customData' in rspFile:
                ...
                customData = None
            file = ModelFile(rspFile['fid'], filename, extraKey,
                             size, timestampNano, absPath, customData)
            files.append(file)
