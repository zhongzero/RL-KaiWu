...
# Module Introduction: This module describes the sample information, including the information contained in each sample and their default values.
...
class SgameExpr:
    def __init__(self):
        """
        Information and default values included in each sample.
