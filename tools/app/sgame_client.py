...
from environment.protocl.proto_king.sgame_ai_server_pb2 import AIServerRequest, \
...
'''
启动命令样例: python client.py --conf=/data/projects/kaiwu-fwk/conf/framework/client.toml
'''
