...
if [ $# -ne 2 ];
then
    echo  -e "\033[31m useage: sh start_multi_game.sh run_times conf_file, such as: sh start_multi_game.sh 1 /data/projects/kaiwu-fwk/conf/framework/client.toml \033[0m"
    exit -1
fi
